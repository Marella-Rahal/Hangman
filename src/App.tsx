...
function App() {
  ...
  const [numberOfWrongGuessed, setNumberOfWrongGuessed] = useState<number>(0);
  ...
  useEffect(() => {
    setIsLoser(numberOfWrongGuessed >= 6 ? true : false);
  }, [numberOfWrongGuessed]);
  ...
  useEffect(() => {
    ...
    if (typeof lastKey === "undefined") return;

    if (!hangmanWord.includes(lastKey)) {
      setNumberOfWrongGuessed((prev) => prev + 1);
    } else {
      setIsWinner(
  ...
  return (
    <div className="w-full flex justify-center items-center">
      <div className="flex flex-col gap-10 justify-center items-center py-3 max-w-[700px]">
        <h1 className="text-2xl text-center">
          {isLoser && "Nice Try ! - Refresh to try again"}
          {isWinner && "You Win O_O - Refresh to try again"}
        </h1>
        <Hangman numberOfWrongGuessed={numberOfWrongGuessed} />
        <HangmanWord
          isLoser={isLoser}
